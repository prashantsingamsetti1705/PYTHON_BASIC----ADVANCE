...
t1=threading.Thread(target=Numbers().odd,args=(int(input("Enter How Many Odd Numbers u want to generate:")),))
t2=threading.Thread(target=Numbers().even,args=(int(input("Enter How Many Even Numbers u want to generate:")),))
